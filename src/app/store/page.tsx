...
export default function StorePage() {
  ...
  const filterAndSortMaterials = useMemo(() => {
    return (materials: RawMaterial[]) => {
      ...
      const filtered = materials.filter((material) => {
        const linkedProduct = getProductForMaterial(
          material,
          material.isMoulded ? "moulded" : material.isFinished ? "machined" : "assembled",
        )
  ...
  }, [finalStock, searchQuery, sortDirection])
              ...
              materials.map((material) => {
                ...
                return (
                  <TableRow key={material.id}>
                    ...
                    <TableCell className="font-mono text-xs">{linkedProduct?.productId || linkedProduct?.id || "—"}</TableCell>
