    ...
    return {
      ...
      batches:
        quantity > 0
          ? [
              {
                batchId: `CSV-${row.productId.trim()}`,
                sourceBatchId: `CSV-${row.productId.trim()}`,
                quantity,
                sku: row.sku.trim(),
                createdAt,
              },
      ...
      >
        {canEditFinalStock && (
          <CSVImportDialog
            ...
            expectedColumns={["productId", "name", "sku", "quantity", "threshold", "price", "gstRate"]}
