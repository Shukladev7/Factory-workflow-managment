...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-16 px-6 text-left align-middle font-semibold text-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-5 text-lg align-middle [&:has([role=checkbox])]:pr-0", className)}
    {...props}
  />
))
